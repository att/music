 ...
 *
 */
public class OriginalZkWriteLock extends ProtocolSupport {
    private static final Logger LOG = LoggerFactory.getLogger(OriginalZkWriteLock.class);
     ...
     */
    public OriginalZkWriteLock(ZooKeeper zookeeper, String dir, List<ACL> acl) {
   //     super(zookeeper);
        this.dir = dir;
        if (acl != null) {
            setAcl(acl);
        ...
        System.out.println("id in constructor.."+id);
    }
